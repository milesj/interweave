...
var Parser = function () {
  ...
  _createClass(Parser, [{
    ...
    value: function applyFilters(attribute, value) {
      var filters = _Interweave2.default.getFilters(attribute);
      var newValue = value;
    ...
    value: function extractAttributes(element) {
      ...
      Array.from(element.attributes).forEach(function (attr) {
        ...
        // Apply filters
        value = _this.applyFilters(name, value);
    ...
    value: function parseNode(parentNode) {
      ...
      Array.from(parentNode.childNodes).forEach(function (node, i) {
        ...
        if (node.nodeType === ELEMENT_NODE) {
          ...
          if (typeof filter === 'undefined' || filter === _constants.FILTER_DENY) {
          ...
          } else if (filter === _constants.FILTER_PASS_THROUGH || noHtml) {
            ...
            content.push(_react2.default.createElement(
              _Element2.default,
              { key: i, tagName: tagName, attributes: _this2.extractAttributes(node) },
